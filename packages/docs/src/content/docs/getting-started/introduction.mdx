...
flaky-tests is a monorepo of focused packages. You only install what you need.

| Package | Role |
|---|---|
| `@flaky-tests/core` | Shared types, ArkType schemas, prompt generation |
...
| `@flaky-tests/cli` | Pattern detection, HTML reports, and issue creation |
