---
title: Quick Start
description: Get flaky-tests running in under two minutes with Bun and SQLite.
---

import { Steps, Tabs, TabItem } from '@astrojs/starlight/components'

This guide uses **Bun** and the default **SQLite** store — the fastest path to capturing test failures locally.
...
- **Using Vitest?** → [Setting up with Vitest](/guides/vitest/)
