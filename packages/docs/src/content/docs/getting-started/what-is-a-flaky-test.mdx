...
- **Start capturing** → [Quick Start](/getting-started/quick-start/)
- **Understand the detection math** → [Scheduled detection](/guides/scheduled-detection/)
- **See what the report looks like** → [Using the HTML report](/guides/html-report/)
