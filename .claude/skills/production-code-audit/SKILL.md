...
trigger_phrase:
  haiku: "production audit security performance"
  opus: "production code audit security performance codebase"
  sonnet: "production audit codebase security performance"
---
